 ...
 *Lab4-Q4
 * SymbolGraph till (input) och Digraph och DepthFirstDirectedPaths till(output)
 */
import Package1.ST;
...
public class SymbolGraph4
{
    ...
    private static Digraf.Digraph G = null; // den underliggande grafen
     ...
     */
    public SymbolGraph4(String filename, String delimiter) {
    ...
    public static void main(String[] args) throws FileNotFoundException
    {
        ...
        SymbolGraph4 st = new SymbolGraph4(lasaOut, " ");
        ...
        //Create a DFS object
        DFDP.DepthFirstDirectedPaths search = new DFDP.DepthFirstDirectedPaths(st.G(), vertex1);
